---
title: "Multivariate_diff_boundary"
...
text <- "Figure 5. Shared difference boundaries (highlighted in red) detected by MDAGAR for each pair of cancer in SIR map. \n The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
...
text <- "Figure 6. Mutual cross-cancer difference boundaries (highlighted in red) detected by MDAGAR for each pair of cancer in SIR map. \n The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
...
name_diff = cbind(name_diff1, name_diff2, name_diff3, name_diff4)
colnames(name_diff) = c("Lung", "Esophageal", "Layrnx", "Coloretal")
knitr::kable(name_diff, caption = "Names of adjacent counties that have significant boundary effect (top 75) from the MCAR model for each cancer individually.")
```
...
text <- "Figure 7. Difference boundaries (highlighted in red and blue) detected by MCAR in SIR map for four cancers individually.\n The blue boundaries are those not included in top 75 edges for lung cancer. The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
plot_0 <- as_ggplot(tgrob) + theme(plot.margin = margin(0,3,0,27, "cm"))
...
text <- "Figure 8. Difference boundaries (highlighted in red and blue) detected by DAGAR_ind in SIR map for four cancers individually.\n The blue boundaries are those not included in top 75 edges for lung cancer. The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
plot_0 <- as_ggplot(tgrob) + theme(plot.margin = margin(0,3,0,27, "cm"))
...
text <- "Figure 9. Shared difference boundaries (highlighted in red) detected by DAGAR_ind for each pair of cancer in SIR map. \n The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
plot_0 <- as_ggplot(tgrob) + theme(plot.margin = margin(0,0,0,32, "cm"))
ggarrange(plot_0, NULL, NULL, edge_plotc12, edge_plotc13, edge_plotc14, 
          edge_plotc23, edge_plotc24, edge_plotc34, nrow = 3, ncol = 3, heights = c(1,5,5))
...
text <- "Figure 10. Difference boundaries (highlighted in red and blue) detected by MDAGAR after accounting for smoking rates.\n The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
...
text <- "Figure 11. Difference boundaries (highlighted in red and blue) detected by MDAGAR after accounting for all covariate.\n The values in brackets are the number of difference boundaries detected"
tgrob <- text_grob(text,size = 12)
plot_0 <- as_ggplot(tgrob) + theme(plot.margin = margin(0,3,0,24, "cm"))
